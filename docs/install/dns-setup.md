...
As mentioned earlier you will need them to create a [wildcard DNS](https://en.wikipedia.org/wiki/Wildcard_DNS_records) entry that points to either the Docker host machine or the Kubernetes Nodes which are running the Ingress Controller.
