...
To get the IAM role ARN created by the SES module and required during [FlowFuse platform configuration](/docs/install/configuration/#aws-ses-email), run the following command:
