...
![Screenshot of FF Tables create database menu](./images/tables/create-database.png)
...
![Screenshot of create tables wizard](./images/tables/create-table-wizard.png)
...
![Screenshot of Tables Explorer](./images/tables/tables-ui-screenshot.png)
...
![Screenshot of Node-RED query node](./images/tables/tables-query-node.png)
...
![Screenshot of credentials](./images/tables/credentials.png)
