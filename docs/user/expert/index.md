...
**FlowFuse Expert is automatically installed and available in all hosted and remote instances running within or connected to FlowFuse**, no manual installation or configuration required. For self-hosted Enterprise customers, FlowFuse Expert can be enabled on request. [Contact us](/contact-us/?subject=FlowFuse%20Expert%20for%20Self-Hosted) to get it set up on your infrastructure.
