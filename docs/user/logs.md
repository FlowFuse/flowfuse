...
- A sparkle icon means the action was performed by FlowFuse Expert through an MCP tool on the user's behalf. Hovering over the icon shows the name of the tool that was called.
