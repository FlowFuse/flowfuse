...
**[OT architectures](/docs/flowfuse-guide/architectures-ot/)** sit near the equipment. They cover edge deployments with the server in IT or in an OT/DMZ, hardware-saving consolidation, and air-gapped sites.

**[IT architectures](/docs/flowfuse-guide/architectures-it/)** are about hosting and governing. They cover on-prem, your own cloud per site, hosting choice at scale, enterprise governance, and secure data exposure.

**[IIoT architectures](/docs/flowfuse-guide/architectures-iiot/)** are the live data backbone: a [Unified Namespace](/docs/user/teambroker/) where the edge publishes once and many subscribe, across every site.
...
Once the code is on a server, it [ships from there](/docs/flowfuse-guide/app-delivery/) through [snapshots](/docs/user/snapshots/) or subflows.
