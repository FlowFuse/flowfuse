<template>
    ...
    <template v-else-if="entry.event === 'resource.cpu'">
        ...
        <span>Instance has spent more than 5 minutes at more than 75% of CPU limit</span>
    </template>

    <template v-else-if="entry.event === 'resource.memory'">
        <label>Instance High Memory usage</label>
        <span>Instance has spent more than 5 minutes at more than 75% of Memory limit</span>
    </template>
