...
import InstanceName from '../instance/components/cells/InstanceName.vue'
...
export default {
    ...
    data () {
        return {
            ...
            instances: [],
            columns: [
                { label: 'Name', class: ['flex-grow'], key: 'name', sortable: true, component: { is: markRaw(InstanceName) } },
