    ...
    <ff-page>
        <template #header>
            <ff-page-header title="Broker" :tabs="tabs">
                <template #context>
                    A list of recent Topics and available MQTT Clients configurable in FlowFuse.
                </template>
                <template #pictogram>
                ...
                <template #helptext>
                    ...
                    <p>Within the Broker, <b>Client</b> page enables seamless client management with customizable Access Control List (ACL) rules for secure and controlled data flow. The topic <b>Hierarchy</b> offers a clear, organized visualization of topic structures, providing fine-grained control over publishing and subscribing permissions.</p>
