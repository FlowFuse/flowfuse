<template>
    <div class="overflow-auto flex flex-col">
        ...
        <template v-if="snapshots.length > 0">
            <ff-data-table data-el="snapshots" class="space-y-4 overflow-auto" :columns="columns" :rows="snapshotsFiltered" :show-search="true" search-placeholder="Search Snapshots...">
                <template #actions>
