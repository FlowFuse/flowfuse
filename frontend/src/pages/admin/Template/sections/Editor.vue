      ...
      <div class="w-full max-w-md sm:mr-8">
        <FormRow
          ...
          :options="[
            ...
            {label: 'America/IndianaKnox',        value: 'America/IndianaKnox'},                                                                        
            {label: 'America/IndianaMarengo',     value: 'America/IndianaMarengo'},                                                                      
            {label: 'America/IndianaPetersburg',  value: 'America/IndianaPetersburg'},                                                                      
            {label: 'America/IndianaTell_City',   value: 'America/IndianaTell_City'},                                                                      
            {label: 'America/IndianaVevay',       value: 'America/IndianaVevay'},                                                                      
            {label: 'America/IndianaVincennes',   value: 'America/IndianaVincennes'},                                                                      
            {label: 'America/IndianaWinamac',     value: 'America/IndianaWinamac'},                                                                      
            ...
            {label: 'America/Noronha',             value: 'America/Noronha'},                                                                      
            {label: 'America/North_DakotaBeulah', value: 'America/North_DakotaBeulah'},                                                                      
            {label: 'America/North_DakotaCenter', value: 'America/North_DakotaCenter'},                                                                                                                                          
            {label: 'America/North_DakotaNew_Salem', value: 'America/North_DakotaNew_Salem'},                                                                    
