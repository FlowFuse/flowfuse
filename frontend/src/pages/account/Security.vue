<template>
    <form class="px-4 sm:px-6 lg:px-8 mt-8 space-y-6">
        ...
        <button type="button" @click="login" class="py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-900 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700">
            Change password
        </button>
