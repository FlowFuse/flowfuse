    ...
    methods: {
        confirm: async function () {
            if (!this.edit) {
                ...
                const token = await devicesApi.createHTTPToken(this.device.id, request.name, request.scope, request.expiresAt)
                ...
                try {
                    await devicesApi.updateHTTPToken(this.device.id, request.id, request.scope, request.expiresAt)
                } catch (err) {
                    console.error(err)
                }
