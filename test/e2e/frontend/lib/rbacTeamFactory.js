...
module.exports = async function (forge) {
    ...
    await assignCustomRoleToApplication(ownerOwen, application1, Roles.Owner)
    await assignCustomRoleToApplication(ownerOwen, application2, Roles.Member)
    await assignCustomRoleToApplication(ownerOwen, application3, Roles.Viewer)
    await assignCustomRoleToApplication(ownerOwen, application4, Roles.dashboard)
    await assignCustomRoleToApplication(ownerOwen, application5, Roles.None)

    await assignCustomRoleToApplication(memberMike, application1, Roles.Owner)
    await assignCustomRoleToApplication(memberMike, application2, Roles.Member)
    await assignCustomRoleToApplication(memberMike, application3, Roles.Viewer)
    await assignCustomRoleToApplication(memberMike, application4, Roles.dashboard)
    await assignCustomRoleToApplication(memberMike, application5, Roles.None)

    await assignCustomRoleToApplication(viewerVictor, application1, Roles.Owner)
    await assignCustomRoleToApplication(viewerVictor, application2, Roles.Member)
    await assignCustomRoleToApplication(viewerVictor, application3, Roles.Viewer)
    await assignCustomRoleToApplication(viewerVictor, application4, Roles.dashboard)
    await assignCustomRoleToApplication(viewerVictor, application5, Roles.None)

    await assignCustomRoleToApplication(dashboardDan, application1, Roles.Owner)
    await assignCustomRoleToApplication(dashboardDan, application2, Roles.Member)
    await assignCustomRoleToApplication(dashboardDan, application3, Roles.Viewer)
    await assignCustomRoleToApplication(dashboardDan, application4, Roles.dashboard)
    await assignCustomRoleToApplication(dashboardDan, application5, Roles.None)

    await assignCustomRoleToApplication(noRoleBarry, application1, Roles.Owner)
    await assignCustomRoleToApplication(noRoleBarry, application2, Roles.Member)
    await assignCustomRoleToApplication(noRoleBarry, application3, Roles.Viewer)
    await assignCustomRoleToApplication(noRoleBarry, application4, Roles.dashboard)
    await assignCustomRoleToApplication(noRoleBarry, application5, Roles.None)
}
