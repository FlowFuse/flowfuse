describe('FlowFuse - Brokers', () => {
    ...
    it('should allow users to configure third party brokers when no brokers exist and then delete it', () => {
        ...
        cy.get('[data-el="listbox-options"][data-select="protocol-options"]').contains('MQTT')
        cy.get('[data-el="listbox-options"][data-select="protocol-options"]').contains('WS')
        cy.get('[data-el="listbox-options"][data-select="protocol-options"] [data-option="WS"]').click()

        cy.get('[data-select="protocolVersion"]').click()
        cy.get('[data-option]').should('have.length', 3)
        cy.get('[data-el="listbox-options"][data-select="protocolVersion-options"]').contains('3.0')
        cy.get('[data-el="listbox-options"][data-select="protocolVersion-options"]').contains('3.1')
        cy.get('[data-el="listbox-options"][data-select="protocolVersion-options"]').contains('5.0')
        cy.get('[data-el="listbox-options"][data-select="protocolVersion-options"] [data-option="5.0"]').click()

        cy.get('[data-select="ssl"]').click()
        cy.get('[data-option]').should('have.length', 2)
        cy.get('[data-el="listbox-options"][data-select="ssl-options"]').contains('Yes')
        cy.get('[data-el="listbox-options"][data-select="ssl-options"]').contains('No')
        cy.get('[data-el="listbox-options"][data-select="ssl-options"] [data-option="Yes"]').click()

        cy.get('[data-select="verifySSL"]').click()
        cy.get('[data-option]').should('have.length', 2)
        cy.get('[data-el="listbox-options"][data-select="verifySSL-options"]').contains('Yes')
        cy.get('[data-el="listbox-options"][data-select="verifySSL-options"]').contains('No')
        cy.get('[data-el="listbox-options"][data-select="verifySSL-options"] [data-option="No"]').click()
