...
describe('FlowFuse - Application - Snapshots', () => {
    ...
    it('offers correct options in snapshot table kebab menu', () => {
        ...
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').should('have.length', MENU_ITEM_COUNT)
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').eq(IDX_VIEW_SNAPSHOT).contains('View Snapshot')
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').eq(IDX_EDIT_SNAPSHOT).contains('Edit Snapshot')
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').eq(IDX_COMPARE_SNAPSHOT).contains('Compare Snapshot...')
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').eq(IDX_DOWNLOAD_SNAPSHOT).contains('Download Snapshot')
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').eq(IDX_DOWNLOAD_PACKAGE).contains('Download package.json')
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').eq(IDX_DELETE_SNAPSHOT).contains('Delete Snapshot')
    ...
    it('provides functionality to view a device snapshot', () => {
        ...
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').eq(IDX_VIEW_SNAPSHOT).click()
    ...
    it('provides functionality to edit a snapshot', () => {
        ...
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').eq(IDX_EDIT_SNAPSHOT).click()
    ...
    it('provides functionality to compare snapshots', () => {
        ...
        cy.get('[data-el="snapshots"] tbody').find('.ff-kebab-menu').eq(1).click()
        // click the View Snapshot option
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').eq(IDX_COMPARE_SNAPSHOT).click()
    ...
    it('download snapshot package.json', () => {
        ...
        cy.get('[data-el="kebab-options"].ff-kebab-options').find('.ff-kebab-item').eq(IDX_DOWNLOAD_PACKAGE).click()
