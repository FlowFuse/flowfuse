#### 3.1.0: Release
 ...
 - docs: agent node installs on the MCP page (#8649)
 - Block out features unavailable to lite agent (#8645)
 - Add agentType to devices and enable lite type registration (#8627)
 - Attribute agent-initiated deploys and installs in the audit log (#8642)
 - Fix audit logs when database deleted (#8647)
 - Git prevent substitution (#8517)
 ...
 - Guard snapshot import against missing, null and unreadable env vars (#8589)
 - Align pipeline rename request schema to the nested body it expects (#8624)
 - Validate snapshot name length with min and max constraints (#8643)
 - Adjust audit log text line height from 1rem to 1.5rem (#8644)
 - Offer prompt suggestions at the start of an Expert conversation (#8595)
 - Add MCP tools for instance lifecycle, settings, config surfaces and files (#8504)
 - Add MCP tool to update an application (#8496)
 - Wait for the full team before deciding onboarding entry (#8628)
 - Render relayed platform notifications as FlowFuse Event cards (#8622)
 - Track the AI-led onboarding funnel in PostHog (#8621)
 - Relay instance start-failure to the Expert over MQTT (#8620)
 - Add MCP tools for broker agent lifecycle and topic writes (#8503)
 - docs: document agent-initiated flow deploy (#8591)
 - Add MCP tools for notification read state, invitations and profile (#8502)
 ...
 - Add MCP tools for device group creation, updates, membership and settings (#8501)
 - build(deps): bump dotenv from 17.4.2 to 18.0.1 (#8608)
 - build(deps): bump ldapts from 9.0.0 to 9.2.0 (#8602)
 - build(deps): bump docker/build-push-action from 7.3.0 to 7.4.0 (#8600)
 - build(deps): bump aws-actions/configure-aws-credentials from 6.2.4 to 6.3.0 (#8605)
 - build(deps): bump docker/setup-buildx-action from 4.3.0 to 4.4.1 (#8606)
 - build(deps): bump docker/setup-qemu-action from 4.3.0 to 4.4.0 (#8603)
 - build(deps): bump google-auth-library from 11.0.2 to 11.1.0 (#8601)
 - build(deps): bump codecov/codecov-action from 7.0.0 to 7.1.1 (#8599)
 - build(deps): bump cypress-io/github-action from 7.4.3 to 7.4.4 (#8597)
 - build(deps): bump @sentry/node from 10.74.0 to 10.75.0 (#8604)
 - build(deps): bump @sentry/vue from 10.74.0 to 10.75.0 (#8598)
 - build(deps): bump mqtt from 5.15.2 to 5.16.0 (#8596)
 - build(deps): bump @aws-sdk/client-sesv2 from 3.1131.0 to 3.1136.0 (#8607)
 - Clarify HITL message when no flow-building tools are listed (#8585)
 - Add MCP tools for snapshot export, import, update and device target (#8497)
 - Support Agent Deploy (#8556)
 - Make a third-party MCP session id safe for the gateway topic (#8565)
 - Fall back to the openai/session meta when no Mcp-Session-Id is supplied (#8561)
 - Await editor readiness in ui_navigate and return context (#8557)
 - feat(mcp): rotate MCP OAuth refresh tokens with replay detection (#8273)
 - build(deps): bump qs, body-parser and express (#8543)
 - Keep a turn's text when its question cards collapse (#8554)
 - feat(expert): structured plan card with active-plan pointer (#8469)
 - feat(expert): pinned task list in the Expert chat (#8468)
 - Fix hydrateMessages silently dropping user messages (#8442)
 - Keep the MCP session up when the active team is refreshed (#8551)
 - Pre-fill MCP access expiry with default of 1 year minus 1 day (#8519)
 - fix: return invalid_grant for a dead MCP refresh token (#8547)
 - Tell the Expert when the workspace instance is ready (#8544)
 - fix: 404 unknown .well-known paths and serve a domain-verification token (#8548)
 - docs: add FlowFuse MCP server capabilities page (#8516)
 - Persist onboarding completion server-side (#8539)
 - Let the user sign out of FlowFuse from the onboarding page (#8541)
 - Add a tile layout to the question option components (#8540)
 - Persist HITL approval outcomes across refresh (#8536)
 - Disable edit-answer chips while the Expert is responding (#8535)
 - Add ui_set_plan_mode tool to toggle plan mode (#8532)
 - Add ui_set_onboarding_phase tool to move the onboarding phase (#8531)
 - Carry the tool audience marker in _meta and tag the browser-session tools (#8530)
 - Send the trial runtime limit in Expert context (#8529)
 - Send the onboarding stage to the Expert in context (#8528)
 - Leave onboarding before ending the intake stage (#8494)
 - user registration: Disallow free email addresses (#8511)
 - Add Claude Code and Codex to the AI connector modal and the docs (#8499)
 - [327] Dashboard adoption tracking in PostHog KPI   (#8356)
 - build(deps): bump js-yaml and @redocly/openapi-core (#8518)
 - build(deps): bump posthog-node from 5.51.6 to 5.52.1 (#8507)
 - build(deps): bump zod from 4.4.3 to 4.6.4 (#8508)
 - Hide google sign-up button is option disabled (#8515)
 - Always reply on team-broker start/stop no-op transitions (#8514)
 - build(deps): bump @sentry/node from 10.70.0 to 10.74.0 (#8506)
 - build(deps): bump @sentry/vue from 10.73.0 to 10.74.0 (#8505)
 - build(deps): bump @aws-sdk/client-sesv2 from 3.1116.0 to 3.1131.0 (#8447)
 - Have the Expert open the onboarding conversation (#8467)
 - Stop the welcome tour firing on the AI onboarding path (#8464)
 - Take a newly registered user into onboarding, and let them out (#8463)
 - Add the AI-led onboarding page (#8440)
 - Add the onboarding surface variant to the expert components (#8439)
 - build(deps): bump nodemailer from 9.0.6 to 10.0.3 (#8444)
 - build(deps): bump @xmldom/xmldom from 0.8.13 to 0.8.15 (#8398)
 - docs: fix the broken links on the documentation home page and across the tree (#8491)
 - Ensure PAT can not delete other tokesn (#8490)
 - Add an AI connector modal reachable from the nav bar (#8483)
 - Cap the Expert bridge heartbeat resync so it fails closed (#8485)
 - ci: Do not cancel `Publish` workflow (#8479)
 - build(deps): bump posthog-node from 5.50.0 to 5.51.6 (#8408)
 - build(deps): bump browserslist from 4.28.6 to 4.28.8 (#8358)
 - build(deps): bump fast-uri from 3.1.5 to 3.1.7 (#8363)
 - build(deps): bump cypress-io/github-action from 7.4.2 to 7.4.3 (#8244)
 - build(deps): bump @sentry/vue from 10.72.0 to 10.73.0 (#8412)
 - build(deps): bump aws-actions/amazon-ecr-login from 2.1.6 to 2.1.7 (#8245)
 - build(deps-dev): bump js-yaml from 3.14.2 to 3.15.2 (#8437)
 - build(deps): bump vue-echarts from 8.1.0 to 8.3.0 (#8445)
 - build(deps): bump inquirer from 14.1.0 to 14.2.1 (#8446)
 - Add housekeeping leadership subscription (#8466)
 - Allow admin to provide list of groupid->name mappings in saml config (#8476)
 - Allow admin to force team type change (#8471)
 - fix: let the MCP consent page scroll when the team list is long (#8472)
 - docs: show the agent picker before the written-out steps (#8321)
 - Add on-demand default workspace provisioning endpoint (#8436)
 - Consolidate default workspace provisioning and skip it for AI onboarding (#8432)
 - Add hidden aiOnboarding platform flag (#8431)
 - Allow SSO Debug logging to be enabled per provider (#8465)
 - Keep a browser session's MCP pins alive across a reload (#8458)
 - Hold tab presence until the loaded entity matches the route (#8461)
...
#### 3.0.0: Release
 ...
 - fix(auth): enforce PAT team scope on entity-addressed routes (#8301)
 - chore: dependency updates (#7767)
 - Force NodeJS 24 for UI tests (#8306)
 - Update git pipelinestage schema to handle null fields (#8304)
 - Move round feature enablement (#8155)
 - [8288] If a team has no dashboard-serving instances, clicking on dashboard tab shows error   (#8294)
 - feat(mcp): gate third-party MCP tool calls on the per-team AI feature (#8296)
 - Improve reliability of browser MCP session pinning (#8289)
 - Fix README logo  (#8300)
 - Revert stray type column in AuthClients migration (#8297)
 - [8268] Prompt users to update nr-launcher for the dashboard cross-site fix   (#8269)
 - Extend mcp tool feature set (#8283)
 - ci: Do not send telemetry anonymously on pre-staging (#8291)
 - feat(mcp): forward telemetry attribution and self-hosted opt-out context (#8279)
 - feat(mcp): attribute third-party MCP audit actions (#8272)
 ...
 - [8277] Fix PostHog group-flag race - Round 2  (#8281)
 - Add browser session gating for tool execution and metadata support (#8276)
 - [8277] Fix PostHog group-flag race (#8278)
 - Hide yearly billing toggle if there are no yearly billing deets to show (#8232)
 - Fix improve forge mcp tools (#8275)
 - Fix readonly MCP flags on ui tools (#8274)
 - Add PostHog flag handling and team-dependent re-evaluation logic (#8267)
 - Update readOnlyHint annotation to false in platform.js (#8262)
 - [8222] Add Google Tag Manager (#8225)
 - build(deps-dev): bump @vitest/coverage-istanbul from 4.1.10 to 4.1.11 (#8251)
 - build(deps): bump uuid from 14.0.1 to 14.0.2 (#8250)
 - build(deps): bump fastify from 5.12.0 to 5.12.1 (#8247)
 - build(deps): bump @aws-sdk/client-sesv2 from 3.1111.0 to 3.1116.0 (#8246)
 - build(deps-dev): bump cypress from 15.20.1 to 15.21.0 (#8249)
 - build(deps): bump docker/setup-buildx-action from 4.2.0 to 4.3.0 (#8248)
 - build(deps): bump posthog-node from 5.49.1 to 5.50.0 (#8252)
 - build(deps-dev): bump sass from 1.102.0 to 1.103.1 (#8257)
 - build(deps): bump dompurify from 3.4.13 to 3.4.14 (#8253)
 - build(deps): bump @fastify/helmet from 13.1.0 to 13.1.1 (#8256)
 - build(deps): bump marked from 18.0.9 to 18.0.10 (#8258)
 - build(deps): bump @aws-sdk/credential-provider-node from 3.972.80 to 3.972.81 (#8255)
 - build(deps-dev): bump vue-tsc from 3.3.10 to 3.3.11 (#8254)
 - build(deps): bump validate-npm-package-name from 7.0.2 to 8.0.0 (#7525)
 - Update minimum NodeJS version to 24 (#8235)
 ...
 - docs: name the file each config snippet belongs in (#8216)
 - [8196] Support popup-window context on the sign-up page (/account/create) (#8228)
 - build(deps-dev): bump @typescript-eslint/eslint-plugin from 8.66.0 to 8.67.0 (#8198)
 - build(deps-dev): bump vue-tsc from 3.3.9 to 3.3.10 (#8208)
 - build(deps): bump @sentry/vue from 10.69.0 to 10.70.0 (#8204)
 - [8227] Move PostHog gating into buildFeatureChecks (#8229)
 - Remove hardcoded permission allowlist for expert MCP tokens (#8185)
 - [8220] A trial team with 'contact sales' enabled is directed to stripe to setup billing (#8223)
 - build(deps-dev): bump @typescript-eslint/parser from 8.66.0 to 8.67.0 (#8206)
 - build(deps): bump @sentry/node from 10.69.0 to 10.70.0 (#8199)
 - build(deps): bump posthog-node from 5.48.1 to 5.49.1 (#8207)
 - build(deps): bump @aws-sdk/client-sesv2 from 3.1106.0 to 3.1111.0 (#8201)
 - build(deps): bump @redis/client from 6.2.0 to 6.2.1 (#8205)
 - build(deps): bump highlight.js from 11.11.1 to 11.12.0 (#8197)
 - build(deps): bump @fastify/multipart from 10.1.0 to 10.1.1 (#8210)
 - build(deps-dev): bump cypress from 15.20.0 to 15.20.1 (#8212)
 - build(deps): bump fastify from 5.11.3 to 5.12.0 (#8211)
 - build(deps): bump cypress-io/github-action from 7.4.1 to 7.4.2 (#8203)
 - feat: add lint rule to enforce kebab-case route names (#8107)
 - Update tab-presence topics to include `browser` prefix and adjust condition checks (#8194)
 - Add SendMqttMessageAwaitReply utility (#8195)
 - Add missing h1s to doc pages (#8193)
 ...
 - Add TabPresencePublisher and MCP toggle integration in ExpertButton component (#8183)
 - Add platform_list_browser_sessions MCP tool (#8184)
 - feat: rename application route names to kebab-case (#8106)
 - [8080] Data Farm >  Hosted Instances 2 - store + first consumer (#8151)
 - [8079] Data Farm > Hosted Instances 1 - backend: lifecycle events   (#8112)
 ...
 - re-sync package-lock.json (#8187)
 - docs: document the project node limitations (#8071)
 - build(deps): bump 1password/install-cli-action from 4.0.0 to 4.1.0 (#7959)
 - build(deps): bump JarvusInnovations/background-action from 1.0.7 to 2.0.0 (#7958)
 - build(deps): bump docker/login-action from 4.4.0 to 4.6.0 (#8033)
 - Persist session ID in sessionStorage for tab identity (#8162)
 - build(deps-dev): bump ws from 8.21.1 to 8.21.3 (#8174)
 - build(deps): bump fastify from 5.11.2 to 5.11.3 (#8176)
 - build(deps-dev): bump eslint-plugin-cypress from 6.4.3 to 6.4.4 (#8180)
 - build(deps-dev): bump postcss from 8.5.25 to 8.5.26 (#8179)
 - build(deps): bump vue-echarts from 8.0.1 to 8.1.0 (#8171)
 - build(deps): bump @fastify/formbody from 8.0.2 to 9.0.0 (#8178)
 - build(deps-dev): bump @fastify/response-validation from 3.0.3 to 3.0.4 (#8177)
 - build(deps): bump posthog-node from 5.47.3 to 5.48.1 (#8175)
 - build(deps): bump marked from 18.0.7 to 18.0.9 (#8173)
 - build(deps): bump @fastify/static from 10.1.2 to 10.1.3 (#8172)
 - build(deps): bump nodemailer from 9.0.3 to 9.0.5 (#8170)
 - build(deps): bump pg from 8.22.0 to 8.23.0 (#8169)
 - build(deps-dev): bump cypress from 15.19.0 to 15.20.0 (#8168)
 - build(deps): bump @aws-sdk/client-sesv2 from 3.1102.0 to 3.1106.0 (#8167)
 - build(deps-dev): bump @typescript-eslint/eslint-plugin from 8.65.0 to 8.66.0 (#8166)
 - build(deps): bump @fastify/routes from 6.0.2 to 6.0.3 (#8165)
 - build(deps-dev): bump mocha from 11.7.6 to 11.8.0 (#8164)
 ...
 - build(deps): bump @sentry/vue from 10.68.0 to 10.69.0 (#8044)
 - build(deps): bump dompurify from 3.4.12 to 3.4.13 (#8150)
 - build(deps-dev): bump webpack-cli from 7.2.1 to 7.2.2 (#8049)
 - build(deps): bump posthog-node from 5.46.1 to 5.47.3 (#8048)
 - build(deps): bump axios from 1.18.1 to 1.19.0 (#8046)
 - build(deps): bump fastify from 5.10.0 to 5.11.2 (#8042)
 - build(deps-dev): bump postcss from 8.5.23 to 8.5.25 (#8043)
 - build(deps): bump @fastify/rate-limit from 11.1.0 to 11.2.0 (#8041)
 - build(deps): bump @fastify/csrf-protection from 8.0.0 to 8.0.1 (#8038)
 - [8075] Data Farm > Teams 2 - active team + subscriber (#8078)
 - [8110] Carried-over status search term breaks pagination on Devices and Application instance/device lists (#8111)
 - [8074] Data Farm > Teams 1 - store + team list (#8077)
 - build(deps-dev): bump jsdom from 29.1.1 to 30.0.1 (#8040)
 - build(deps): bump @redis/client from 6.1.0 to 6.2.0 (#8039)
 - build(deps-dev): bump vue-tsc from 3.3.8 to 3.3.9 (#8036)
 - build(deps): bump @aws-sdk/client-sesv2 from 3.1095.0 to 3.1102.0 (#8035)
 - build(deps): bump @sentry/node from 10.68.0 to 10.69.0 (#8034)
 - build(deps-dev): bump webpack from 5.109.0 to 5.109.2 (#8032)
 - build(deps): bump @fastify/swagger-ui from 6.1.0 to 6.1.1 (#8031)
 - feat: rename Team and Applications route names to kebab-case (#8105)
 - feat: rename Home and team navigation route names to kebab-case (#8104)
 - feat: rename team action route names to kebab-case (#8103)
 - feat: rename low-ref team route names to kebab-case (#8102)
 - feat: rename team library route names to kebab-case (#8101)
 - feat: rename account route names to kebab-case (#8099)
 - feat: rename help, admin parent, and user settings route names to kebab-case (#8100)
 - fix(expert): remove dead resources answer kind from AnswerBadge (#8004)
 - build(deps): bump fast-uri from 3.1.4 to 3.1.5 (#8060)
 - build(deps-dev): bump brace-expansion from 1.1.13 to 1.1.18 (#8068)
...
#### 2.33.0: Release
 ...
 - 2.33 Release Docs Update (#8005)
 - Update Device Agent docs for new onboarding (#8001)
 - fix(expert): prevent human chat bubble overflowing past panel width (#8003)
 ...
 - Update Expert Docs for 2.32 (#7660)
 - [7997] Dashboards - move the drawer toggle to the right side   (#7998)
 - feat(mcp): add FlowFuse Tables platform automation tools (#7990)
 - fix(tables): make the feature-gate 404 message explicit (#7994)
 - Fix: guide header steps disappear after reopening expert drawer (#7991)
 ...
 - fix(tables): include schema in tables list, fix data queries and show schema in UI (#7951)
 - build(deps): bump actions/setup-node from 6.4.0 to 7.0.0 (#7852)
 - build(deps): bump actions/checkout from 7.0.0 to 7.0.1 (#7855)
 - fix(mcp): stop empty UI-tool errors and tighten tool-usage guardrails (#7911)
 - [7876] Remote instances: consolidate buttons on details page and move status column on list    (#7975)
 - [7883] Paginating hosted instances can return an incorrect count which leads to a blank page at the end of results (#7976)
 - [7926] Frontend: Search for dashboard drawer & expert button bug (#7939)
 - fix(mcp): forward device comms to platform automation tool calls (#7936)
 - build(deps-dev): bump @vitest/coverage-istanbul from 4.1.9 to 4.1.10 (#7814)
 - build(deps-dev): bump cypress from 15.18.1 to 15.19.0 (#7972)
 - build(deps-dev): bump postcss from 8.5.20 to 8.5.23 (#7971)
 - build(deps-dev): bump webpack from 5.108.4 to 5.109.0 (#7969)
 - build(deps): bump posthog-node from 5.45.2 to 5.46.1 (#7968)
 - build(deps): bump @aws-sdk/client-sesv2 from 3.1090.0 to 3.1095.0 (#7967)
 - build(deps-dev): bump sass from 1.101.0 to 1.102.0 (#7960)
 - build(deps): bump @sentry/node from 10.66.0 to 10.68.0 (#7965)
 - build(deps-dev): bump sinon from 22.0.0 to 22.1.0 (#7964)
 - build(deps-dev): bump vue-tsc from 3.3.7 to 3.3.8 (#7963)
 - build(deps-dev): bump html-webpack-plugin from 5.6.7 to 5.6.8 (#7962)
 - build(deps): bump @sentry/vue from 10.67.0 to 10.68.0 (#7956)
 - build(deps-dev): bump @typescript-eslint/eslint-plugin from 8.64.0 to 8.65.0 (#7957)
 - build(deps-dev): bump eslint-plugin-vue from 10.9.2 to 10.10.0 (#7953)
 - build(deps-dev): bump webpack-dev-server from 5.2.5 to 5.2.6 (#7947)
 - build(deps): bump @aws-sdk/credential-provider-node from 3.972.70 to 3.972.72 (#7970)
 - build(deps): bump marked from 18.0.6 to 18.0.7 (#7974)
 - build(deps): bump google-auth-library from 10.9.0 to 10.9.1 (#7973)
 - [7926] Frontend: dashboard buttons open embedded viewer or direct link (#7938)
 - Fix: related flows hidden after non-streamed render (#7948)
 - Fix expert chat input focus on drawer open and after MQTT response (#7933)
 - build(deps-dev): bump immutable from 5.1.5 to 5.1.9 (#7929)
 - build(deps): bump @fastify/static from 10.1.0 to 10.1.2 (#7942)
 - build(deps): bump tar from 7.5.20 to 7.5.22 (#7943)
 - build(deps): bump find-my-way from 9.6.0 to 9.7.0 (#7941)
 - Resync package-lock.json (#7945)
 - build(deps): bump fast-uri from 3.1.2 to 3.1.4 (#7940)
 ...
 - [7874]  Refactor immersive editor logic into shared composable + move shared styles  (#7904)
 - Fix device assignment (F3) (#7897)
 - fix: use a shared subscription for the Expert platform request bridge source (#7893)
 - Fix color linting script for cross platform development (#7776)
 - ci: Fix typo in the pre-staging init script (#7903)
 - ci: Fix database setup steps in the pre-staging init script (#7902)
 - Enabled Expert Insights by default for self-hosted (#7895)
 - Ensure return after res.send() called (#7886)
 - build(deps): bump tar from 7.5.16 to 7.5.20 (#7890)
 - build(deps): bump shell-quote from 1.8.4 to 1.10.0 (#7889)
 - build(deps): bump body-parser from 1.20.5 to 1.20.6 (#7888)
 - build(deps-dev): bump ws from 8.21.0 to 8.21.1 (#7864)
 - Add embedded dashboard tab to instance page (#7885)
 - build(deps): bump @sentry/vue from 10.65.0 to 10.67.0 (#7866)
 - Add application-level dashboard-instances API endpoint (#7882)
 - build(deps): bump @sentry/node from 10.65.0 to 10.66.0 (#7862)
 ...
 - [7869] Feature flag: EMBEDDED_DASHBOARD_ENABLED (#7877)
 ...
 - build(deps-dev): bump eslint-plugin-cypress from 6.4.2 to 6.4.3 (#7868)
 - build(deps-dev): bump autoprefixer from 10.5.2 to 10.5.4 (#7863)
 - build(deps-dev): bump postcss from 8.5.17 to 8.5.20 (#7865)
 - build(deps-dev): bump @tailwindcss/postcss from 4.3.2 to 4.3.3 (#7867)
 - build(deps): bump posthog-node from 5.41.0 to 5.45.2 (#7860)
 - build(deps): bump @fastify/cookie from 11.1.1 to 11.1.2 (#7859)
 - build(deps-dev): bump @vitejs/plugin-vue from 6.0.7 to 6.0.8 (#7856)
 - build(deps): bump @aws-sdk/client-sesv2 from 3.1085.0 to 3.1090.0 (#7853)
...
#### 2.32.0: Release
 ...
 - Validate instance ID type for MCP requests to prevent cache key errors (#7655)
 ...
 - [7644] Dropdowns that allow manual input will not accept inputs that are prefix of offered options   (#7646)
 ...
 - build(deps): bump @headlessui/vue from 1.7.19 to 1.7.23 (#7484)
 - Remove postcss-preset-env dependency  (#7636)
 - build(deps): bump actions/cache from 5.0.5 to 6.1.0 (#7614)
 - build(deps): bump untitaker/hyperlink from 0.2.1 to 0.3.2 (#7612)
 - build(deps-dev): bump nyc from 15.1.0 to 18.0.0 (#7590)
 - build(deps-dev): bump webpack-cli from 7.0.3 to 7.1.0 (#7622)
 - build(deps-dev): bump webpack from 5.107.2 to 5.108.1 (#7619)
 - build(deps-dev): bump autoprefixer from 10.5.0 to 10.5.2 (#7615)
 - build(deps): bump posthog-node from 5.38.2 to 5.38.6 (#7611)
 - build(deps): bump fastify-metrics from 13.2.0 to 13.2.1 (#7623)
 - [5294] Git Integration in a DevOps Pipeline (#7435)
 - build(deps): bump marked from 15.0.7 to 18.0.5 (#7506)
 - build(deps): bump @sentry/node from 10.59.0 to 10.62.0 (#7624)
 - build(deps): bump @fastify/rate-limit from 11.0.0 to 11.1.0 (#7630)
 - build(deps): bump @aws-sdk/client-sesv2 from 3.1073.0 to 3.1075.0 (#7626)
 - build(deps): bump @sentry/vue from 10.59.0 to 10.62.0 (#7629)
 - build(deps-dev): bump @typescript-eslint/eslint-plugin from 8.61.1 to 8.62.0 (#7613)
 - build(deps-dev): bump @typescript-eslint/parser from 8.61.1 to 8.62.0 (#7632)
 - build(deps-dev): bump cypress from 15.17.0 to 15.18.0 (#7633)
 - build(deps): bump axios from 1.18.0 to 1.18.1 (#7631)
 - build(deps-dev): bump ts-loader from 9.6.1 to 9.6.2 (#7628)
 - build(deps-dev): bump postcss from 8.5.15 to 8.5.16 (#7627)
 - build(deps): bump @redis/client from 6.0.0 to 6.0.1 (#7625)
 - build(deps): bump fastify from 5.8.5 to 5.9.0 (#7621)
 - build(deps): bump aws-actions/configure-aws-credentials from 6.2.0 to 6.2.1 (#7617)
 - build(deps): bump @aws-sdk/credential-provider-node from 3.972.57 to 3.972.58 (#7618)
 - build(deps): bump google-auth-library from 10.7.0 to 10.9.0 (#7616)
 ...
 - Combine several dependabot Fastify updates (#7600)
 - build(deps): bump @aws-sdk/client-sesv2 from 3.988.0 to 3.1073.0 (#7582)
 - build(deps): bump actions/checkout from 6.0.3 to 7.0.0 (#7585)
 - build(deps-dev): bump mini-css-extract-plugin from 2.9.0 to 2.10.2 (#7471)
 - Store device nodejs version (#7577)
 - [7521] Sync FlowFuse theme preference into the embedded Node-RED editor (#7523)
 - build(deps-dev): bump @tailwindcss/postcss from 4.2.4 to 4.3.1 (#7459)
 - [7578] Hosted Instances search field auto-submits and clears input when no matching results are found (#7597)
 - build(deps-dev): bump @types/mqtt from 0.0.34 to 2.5.0 (#7539)
 - build(deps-dev): bump autoprefixer from 10.4.16 to 10.5.0 (#7532)
 - [7154] Follow Up: Poor UX when editor is disabled in immersive mode (#7180)
 - build(deps-dev): bump dotenv-webpack from 8.0.1 to 9.0.0 (#7468)
 - build(deps): bump dotenv from 16.4.5 to 17.4.2 (#7502)
 - Bump cross-env from 7.0.3 to 10.1.0 (#7470)
 - build(deps): bump @sentry/vue from 10.54.0 to 10.59.0 (#7595)
 - build(deps): bump uuid from 14.0.0 to 14.0.1 (#7591)
 - build(deps): bump @sentry/node from 10.57.0 to 10.59.0 (#7589)
 - Bump vue3-google-login from 2.0.33 to 2.1.4 (#7467)
 - build(deps): bump semver from 7.8.4 to 7.8.5 (#7587)
 - build(deps-dev): bump style-loader from 3.3.4 to 4.0.0 (#7540)
 - build(deps): bump @aws-sdk/credential-provider-node from 3.972.55 to 3.972.57 (#7583)
 - build(deps-dev): bump ts-loader from 9.6.0 to 9.6.1 (#7584)
 - Bump @node-red/util from 4.1.2 to 5.0.0 (#7463)
 - build(deps): bump ldapts from 7.0.12 to 8.1.8 (#7594)
 - build(deps-dev): bump sass from 1.97.3 to 1.101.0 (#7533)
 - build(deps-dev): bump eslint-plugin-promise from 6.1.1 to 6.6.0 (#7529)
 - build(deps): bump posthog-node from 5.37.0 to 5.38.2 (#7588)
 - build(deps-dev): bump @typescript-eslint/eslint-plugin from 8.58.0 to 8.61.1 (#7592)
 - build(deps): bump pg from 8.21.0 to 8.22.0 (#7593)
 - build(deps-dev): bump css-loader from 7.1.2 to 7.1.4 (#7474)
 - build(deps-dev): bump jsdom from 25.0.1 to 29.1.1 (#7537)
 - Fix Dark Mode OS icons being unreadable (#7574)
 - build(deps): bump nodemailer from 9.0.0 to 9.0.1 (#7576)
 - build(deps): bump dompurify from 3.4.10 to 3.4.11 (#7575)
 - Add httpTokens end points for Devices (#7568)
 - [7569] Device editor: redirect parent instead of iframe (flowfuse frontend) (#7570)
 ...
 - [7320] Live team updates over MQTT/WS (#7327)
 - build(deps): bump @fastify/swagger from 9.6.1 to 9.7.0 (#7535)
 - build(deps-dev): bump @vue/test-utils from 2.4.6 to 2.4.11 (#7531)
 - build(deps-dev): bump webpack-cli from 7.0.2 to 7.0.3 (#7541)
 - build(deps): bump qs and express (#7547)
 - build(deps-dev): bump cypress from 15.14.2 to 15.17.0 (#7534)
 - build(deps-dev): bump esbuild from 0.25.3 to 0.25.12 (#7546)
 - build(deps): bump vite, @vitejs/plugin-vue, @vitest/coverage-istanbul and vitest (#7520)
