...
module.exports = {
  ...
  create: async (id, options) => {
    ...
    localPod.spec.containers[0].env({name: "FORGE_CLIENT_ID", value=options.clientID});
    localPod.spec.containers[0].env({name: "FORGE_CLIENT_SECRET", value=options.clientSecret});
    localPod.spec.containers[0].env({name: "FORGE_URL", value=process.env["BASE_URL"]});
    localPod.spec.containers[0].env({name: "BASE_URL", value=`http://${options.name}.${this._options.domain}`});
