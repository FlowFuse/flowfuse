...
module.exports = {
  ...
  create: async (id, options) => {
    ...
    localPod.spec.containers[0].env.push({name: "FORGE_AUDIT_URL", value: process.env["BASE_URL"] + "/logging"});
    localPod.spec.containers[0].env.push({name: "FORGE_AUDIT_TOKEN", value: options.loggingSecret || "forbar"});
